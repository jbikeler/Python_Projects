...
class ParentWindow(Frame):
    ...
    def __init__(self, master):
        ...
        self.exit_btn.grid(row=2, column=3, padx=(10, 40), pady=(0, 15))
    ...
    def destDir(self):
        ...
        #The .insert metfiod will insert the user selection to the destination dir Entry widget
    ...
    def transferFiles(self):
        ...
        for i in source_files:
            ...
            edit_time = datetime.fromtimestamp(os.path.getmtime(source + '/' + i))
            #get current time as datetime object
            current_time = datetime.now()
            #get difference between the two
            diff = edit_time - current_time
            #if the diff is less than a day (86400 seconds) then move the files
            print(-1 * diff.total_seconds())
            if (-1 * diff.total_seconds()) < 86400:
